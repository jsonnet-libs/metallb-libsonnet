{
  ...
  spec: {
    ...
    '#passwordSecret':: d.obj(help='"passwordSecret is name of the authentication secret for BGP Peer.\\nthe secret must be of type \\"kubernetes.io/basic-auth\\", and created in the\\nsame namespace as the MetalLB deployment. The password is stored in the\\nsecret as the key \\"password\\"."'),
    passwordSecret: {
      ...
      withNamespace(namespace): { spec+: { passwordSecret+: { namespace: namespace } } },
    },
    '#withBfdProfile':: d.fn(help="\"The name of the BFD Profile to be used for the BFD session associated to the BGP session. If not set, the BFD session won't be set up.\"", args=[d.arg(name='bfdProfile', type=d.T.string)]),
    withBfdProfile(bfdProfile): { spec+: { bfdProfile: bfdProfile } },
    '#withConnectTime':: d.fn(help='"Requested BGP connect time, controls how long BGP waits between connection attempts to a neighbor."', args=[d.arg(name='connectTime', type=d.T.string)]),
    withConnectTime(connectTime): { spec+: { connectTime: connectTime } },
    '#withDisableMP':: d.fn(help='"To set if we want to disable MP BGP that will separate IPv4 and IPv6 route exchanges into distinct BGP sessions."', args=[d.arg(name='disableMP', type=d.T.boolean)]),
    withDisableMP(disableMP): { spec+: { disableMP: disableMP } },
    '#withEbgpMultiHop':: d.fn(help='"To set if the BGPPeer is multi-hops away. Needed for FRR mode only."', args=[d.arg(name='ebgpMultiHop', type=d.T.boolean)]),
    withEbgpMultiHop(ebgpMultiHop): { spec+: { ebgpMultiHop: ebgpMultiHop } },
    '#withEnableGracefulRestart':: d.fn(help='"EnableGracefulRestart allows BGP peer to continue to forward data packets along\\nknown routes while the routing protocol information is being restored.\\nThis field is immutable because it requires restart of the BGP session\\nSupported for FRR mode only."', args=[d.arg(name='enableGracefulRestart', type=d.T.boolean)]),
    withEnableGracefulRestart(enableGracefulRestart): { spec+: { enableGracefulRestart: enableGracefulRestart } },
    ...
    '#withVrf':: d.fn(help='"To set if we want to peer with the BGPPeer using an interface belonging to\\na host vrf"', args=[d.arg(name='vrf', type=d.T.string)]),
    withVrf(vrf): { spec+: { vrf: vrf } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
